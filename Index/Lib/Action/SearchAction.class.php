...
class SearchAction extends CommonAction
{
    public function index()
    {
    	...
    	$this->assign('distance_rangedata',$distance_rangedata);
    ...
    //获取查询条件
    	$data = Init_GP(array('search_key','favorites','minprice','maxprice','region','category','sort','promulgator','mindistance','maxdistance','recommend','evaluate'));
    	$map = $this->_filters($data);
    	$goods = D('Goods');
    ...
    public function regionAll(){
    	$data = Init_GP(array('search_key','favorites','region','inputType','minprice','maxprice','all'));
    	$map = $this->_filters($data);
    	unset($map['rid']);
    	//统计分类中符合条件的数量
    	$region = D('Region');
	...
	public function categoryAll(){
    	$data = Init_GP(array('search_key','favorites','category','inputType','minprice','maxprice','all'));
    	$map = $this->_filters($data);
    	unset($map['cid']);
    	//统计分类中符合条件的数量
