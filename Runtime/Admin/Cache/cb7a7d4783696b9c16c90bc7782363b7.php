...
<div class="pageContent">
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="600" orderField="name" <?php if($_REQUEST["_order"] == 'name'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>标签名称</th>
			<th width="80" orderField="count" <?php if($_REQUEST["_order"] == 'count'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>统计</th>
			<th width="80">操作</th>
		</tr>
		</thead>
		<tbody>
