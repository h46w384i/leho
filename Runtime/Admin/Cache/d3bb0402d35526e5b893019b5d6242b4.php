...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>参数键：</label>
				<input type="text" class="alphanumeric" name="key">
			</li>
            <li>
				<label>参数名称：</label>
...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="__URL__/add" target="dialog" rel="__MODULE___add" height="310"><span>新增</span></a></li>
			...
			<li><a class="edit" href="__URL__/edit/id/{sid_node}" target="dialog" rel="__MODULE___edit" warn="请选择" height="310"><span>修改</span></a></li>
		</ul>
	</div>
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="80">编号</th>
			<th width="150" orderField="key" <?php if($_REQUEST["_order"] == 'key'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>参数键</th>
			<th>参数名称</th>
			<th width="120" orderField="group_id" <?php if($_REQUEST["_order"] == 'group_id'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>所属组</th>
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getSysconf_groupName($vo['group_id'])); ?></td>
				<td>
