...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class=""><a target="dialog" href="__URL__/tree/" rel="__MODULE___tree" class="icon" callback="Articles_categoryTree"><span>树形</span></a></li>
			<li class="line">line</li>
			<li><a class="back" href="__URL__/index/nav/back" target="navTab" rel="Articles_category" title="文章分类"><span>后退</span></a></li>
		</ul>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="800" orderField="name" <?php if($_REQUEST["_order"] == 'name'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>分类名称</th>
			<th width="100">父类</th>
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getParent('Articles_category',$vo['pid'])); ?></td>
				<td>
