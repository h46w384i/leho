...
<div class="pageContent">
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="600" orderField="title" <?php if($_REQUEST["_order"] == 'title'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>专题名称</th>
			<th width="80" orderField="sort" <?php if($_REQUEST["_order"] == 'sort'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>序号</th>
			<th width="100" orderField="addtime" <?php if($_REQUEST["_order"] == 'addtime'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>发布时间</th>
			<th width="80">操作</th>
		</tr>
		</thead>
		<tbody>
