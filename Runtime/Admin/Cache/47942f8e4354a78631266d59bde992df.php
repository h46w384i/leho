...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="back" href="__URL__/index/nav/back" target="navTab" rel="Businesses_category" title="商品分类"><span>后退</span></a></li>
		</ul>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getParent('Businesses_category',$vo['pid'])); ?></td>
