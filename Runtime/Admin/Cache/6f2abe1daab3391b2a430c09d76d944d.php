...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>商家：</label>
				<input name="bid" type="hidden" group="businesses" field="id"/>
				<input name="title" type="text" readonly="readonly" group="businesses" field="name"/>
				<a class="btnLook" href="<?php echo U('Businesses/lookUp/group/businesses/');?>" target="dialog" rel="businesses_lookup">查找带回</a>
			</li>
		</ul>
		<div class="subBar">
			<ul>
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getParent('Businesses',$vo['bid'],'name')); ?></td>
				<td>
