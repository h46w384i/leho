...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
            ...
            <li class=""><a class="icon" href="__URL__/batch/"  target="dialog"  rel="__MODULE___batch" width="650" height="490"><span>地图批量生成</span></a></li>
		</ul>
	</div>
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="600" orderField="title" <?php if($_REQUEST["_order"] == 'title'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>标题</th>
			<th width="80">所属分类</th>
