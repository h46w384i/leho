...
<div id="bd" class="bb-t4 message">
	<div id="main">
           <div class="inner">
               ...
               <div class="mes-nav">
                   <ul class="cls">
                       <li class="selected"><a href="<?php echo U('Member/comment');?>" onclick="return false;">评论</a></li>
                       <li><a href="<?php echo U('Member/at');?>">提到我的</a></li>
                       <li><a href="<?php echo U('Member/liked');?>">喜欢</a></li>
                   </ul>
                   <div class="message-date cls">
                   									<a href="" class="selected" onclick="return false;">收到的评论</a><span>(<?php echo ($count); ?>)</span><a href="<?php echo U('Member/comment_send');?>">发出的评论</a><span>(<?php echo ($sendcount); ?>)</span>
						                   </div>
               </div>
               <div class="comment-lst">
                   						<ul>
                   						<?php if(is_array($talk_about_commentdata)): $i = 0; $__LIST__ = $talk_about_commentdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="cls">
								<div class="cmt-lst-l">
									<a href="<?php echo U('User/space/id/'.$vo['uid']);?>" class="head">
										<img src="<?php echo ($vo["header"]); ?>">
									</a>
								</div>
								<div class="cmt-lst-c">
									<p>
										<span class="cmt-ori">
										<a href="<?php echo U('User/space/id/'.$vo['uid']);?>"><?php echo ($vo["name"]); ?></a>:
										</span>
										<?php echo (contentFilter($vo["content"])); ?>
										<span class="send-time">
											(<?php echo (dgmdate($vo["addtime"])); ?>)
										</span>
									</p>
									<p>
										<span>
										...
										<span>的分享:</span>
										<?php echo (contentFilter($vo["talk_content"])); ?>
									</p>
									<p></p>
									<p class="cmt-tools"><span class="cmt-del"><a href="javascript:;" class="del" cid="<?php echo ($vo["id"]); ?>">删除</a><i class="split">|</i></span><a class="cmt-reply" href="javascript:;" data-info="<?php echo ($vo["name"]); ?>">回复</a></p>
									<div class="comment">
										<div class="comment-post list-com" style="display:none">
											<div class="comment-textarea">
											<form class="comment_form">
												<input type="hidden" name="tid" value="<?php echo ($vo["tid"]); ?>" />
												<div class="txt">
         ...
         <div class="bd">
             ...
             <div class="main cls">
                <div class="moudle-content">
                    <p>欢迎使用并提出宝贵建议</p>
                    <p>你可以通过以下方式提交意见反馈：</p>
                    <p>发邮件至<?php echo C("sysconfig.site_services_email");?></p>
                </div>
             </div>
         </div>
         <div class="ft"></div>
