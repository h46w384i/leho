	...
	<div id="bd" class="bb-t4 message">
		<div id="main">
            <div class="inner">
                ...
                <div class="mes-nav">
                    <ul class="cls">
                    	<li class="selected"><a href="<?php echo U('Circle/ajaxCircle/myoriginal/1');?>" onclick="return false;">原创<span>(<?php echo ($original); ?>)</span></a></li>
	                    <li><a href="<?php echo U('Circle/ajaxCircle/myforwarding/1');?>" onclick="return false;">转发<span>(<?php echo ($forwarding); ?>)</span></a></li>
                    </ul>
                </div>
