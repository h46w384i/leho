...
<div class="myhome-nav">
	...
	<a href="<?php echo U('Circle/ajaxCircle/uid/'.$memberdata['id']);?>" onclick="return false" class="tab selected" data-feed_type="1">
		<i class="dynamic"></i><span>好友动态</span>
	</a>
	<a href="<?php echo U('Member/periphery');?>" class="tab " data-feed_type="2">
...
<div id="bd" class="bb-t1">
	<div id="main">
		<div class="column-wraper cls">
			<div class="moudle-block moudle daren-tuijian jvf_pubu" data-feed_type="1" style="">
			<!--{start: 达人推荐 -->
				<div class="hd"></div>
				<div class="bd">
					<div class="title"><span>达人推荐</span></div>
					<div class="main cls">
						<ul class="mo-user-list">
							<?php if(is_array($darendata)): $i = 0; $__LIST__ = $darendata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="daren">
	<div class="user-photo">
		<a href="<?php echo U('User/space/id/'.$vo['id']);?>"><img src="<?php echo ($vo["header"]["thumbnail"]); ?>" alt="<?php echo ($vo["name"]); ?>" width="30" height="30"></a>
	</div>
	<div class="user-content">
		<strong>
			<a href="<?php echo U('User/space/id/'.$vo['id']);?>" title="<?php echo ($vo["name"]); ?>"><?php echo (msubstr($vo["name"],0,5)); ?></a>
<a class="ico-approve approve-person-s" href="<?php echo U('Index/daren');?>" target="_blank" title="达人认证"></a>		</strong>
		<span title="<?php echo ($vo['self_introduction']); ?>"><?php echo (msubstr($vo['self_introduction'],0,5)); ?></span>
	</div>
	<a class="btn-follow-22-add add-attention" href="#" onclick="return false" uid=<?php echo ($vo["id"]); ?>><span>加关注</span></a>
	<a href="#" onclick="return false" class="close" style="display: none; "></a>
</li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
						<div class="block-loading loading" style="display:none; height:122px;"></div>
						<div class="other-block">
							<a href="#" onclick="return false" class="switch">换一组</a>
