...
<div id="wrapper">		
	...
	<div class="mylife-cont">
		...
		<div class="mylife-bd">
			<table class="myzhanghu">
				<tr>
                	<td class="jvf_tr" width="40%">商家：</td>
                	<td>
	                	<?php if(empty($businessesdata)): ?><a href="<?php echo U('Member/applyBusiness');?>">申请入住</a>
	                    <?php else: ?>
	                    <?php if(($businessesdata["status"])  ==  "1"): ?><a href="<?php echo U('Company/index');?>"><?php echo ($businessesdata["name"]); ?></a>审核通过    <a href="<?php echo U('Company/index');?>">管理</a><?php else: ?>正在审核<?php endif; ?><?php endif; ?>
                    </td>
                </tr>
                <tr>
                	<td class="jvf_tr">现金：</td>
                    <td><?php echo ($memberdata["cash"]); ?> <a href="<?php echo U('Member/recharge');?>">充值</a></td>
                </tr>
                <tr>
                	<td class="jvf_tr">积分：</td>
                    <td><?php echo ($memberdata["value"]); ?></td>
                </tr>
                <tr>
                	<td class="jvf_tr">等级：</td>
                	<td><?php echo ($memberdata["level"]["name"]); ?></td>
                </tr>
                <tr>
                	<td class="jvf_tr">勋章：</td>
                     <td>
                     <?php if(is_array($medaldata)): $i = 0; $__LIST__ = $medaldata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><img src="<?php echo ($vo["logopath"]); ?>" alt="<?php echo ($vo["name"]); ?>--<?php echo ($vo["mark"]); ?>" /><?php endforeach; endif; else: echo "" ;endif; ?>
                     </td>
                </tr>
            </table>
		</div>
...
<div class="mylife-nav">
	<dl>
		<dt>我的信息</dt>
		<dd <?php if((ACTION_NAME)  ==  "account"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/account');?>">我的账户</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "buyOrderList"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/buyOrderList');?>">购买订单</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "viewo_details"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/viewo_details');?>">购买详单</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "mycoupons"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/mycoupons');?>">我的优惠券</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "cashlogs"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/cashlogs');?>">账户日志</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "rechargeList"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/rechargeList');?>">充值日志</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "valueLog"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/valueLog');?>">积分日志</a></dd>
		<dd <?php if((ACTION_NAME)  ==  "chatLog"): ?>class="selected"<?php endif; ?>><a href="<?php echo U('Member/chatLog');?>">聊天日志</a></dd>
	</dl>
</div>
</div>
	</div>
