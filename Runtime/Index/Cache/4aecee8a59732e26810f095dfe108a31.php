...
<div class="myhome-nav">
	<a href="<?php echo U('Circle/ajaxCircle/uid/'.$memberdata['id']);?>" onclick="return false" class="tab selected" data-feed_type="0">
...
<div id="bd" class="bb-t1">
	<div id="main">
		...
		<?php if(empty($interestdata)): ?><div class="block-empty interest" data-feed_type="0" style="">
				<div class="explain-empty">
					<p>啊哦，这里还是空的…</p>
					<p>添加你喜欢的兴趣，<span class="font-color1">精彩内容</span>自动送上门！</p>
				</div>
				<a href="#" onclick="return false" class="empty-btn-add add-group"><span>添加兴趣</span> </a>
			</div>
		<?php else: ?>
			<div class="moudle-block moudle tag-list interest jvf_pubu" data-feed_type="0" id="interest" style="">
				<div class="hd"></div>
				<div class="bd">
					<div class="title"><span>我的关注</span></div>
					<div class="main cls">
						<div class="tag-block">
							<div class="tag-bd" style="max-height: 228px; overflow: hidden; ">
								<ul class="interest-list cls">
									<?php $count = count($interestdata); ?>
									<?php if(($count)  >  "1"): ?><li class="interest-tag selected" lid="0" uid="<?php echo ($memberdata["id"]); ?>">
									<a href="#" onclick="return false;">全部</a>
									</li><?php endif; ?>
									<?php if(is_array($interestdata)): $i = 0; $__LIST__ = $interestdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li class="interest-tag <?php if(($count)  <  "2"): ?><?php if(($i)  ==  "1"): ?>selected<?php endif; ?><?php endif; ?>" lid="<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["name"]); ?>">
						...
						<div class="other-block">
							<a href="#" onclick="return false" class="add-group">+ 添加兴趣</a>
