...
<div id="bd">
			...
			<div id="core">
				<div id="slide">
					<div class="pics switch-fade">
						<?php echo showAdvPosition('app_top');?>
					</div>
					<div class="shadow"></div>
				</div>

				<div class="applist">
					<?php if(is_array($all)): $i = 0; $__LIST__ = $all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="section">
						<h2 class="tt-1"><span><?php echo ($vo["name"]); ?></span></h2>
						<ol class="more switch-nav">
							<?php if(is_array($vo["apps"])): $i = 0; $__LIST__ = $vo["apps"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): ++$i;$mod = ($i % 12 )?><?php if(($mod)  ==  "1"): ?><?php if(count($vo['apps']) > 12): ?><?php if(($i)  ==  "1"): ?><li class="selected"><?php echo ($i); ?></li>
								<?php else: ?>
								<li><?php echo ($i); ?></li><?php endif; ?><?php endif; ?><?php endif; ?><?php endforeach; endif; else: echo "" ;endif; ?>
						</ol>
						<div class="cells switch-content">
						<?php if(is_array($vo["apps"])): $i = 0; $__LIST__ = $vo["apps"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): ++$i;$mod = ($i % 12 )?><?php if(($mod)  ==  "1"): ?><?php if(($i)  ==  "1"): ?><div class="container selected">
								<?php else: ?>
								<div class="container"><?php endif; ?><?php endif; ?>
							
							<dl>
								<dd class="pic"><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><img src="<?php echo ($v["accessory"]["origin"]); ?>" alt="<?php echo ($v["name"]); ?>"><span class="cover"></span></a></dd>
								<dt><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><?php echo ($v["name"]); ?></a></dt>
							</dl>
							<?php if(($mod)  ==  "0"): ?></div>
							<?php else: ?>
							<?php if(count($vo['apps']) == $i): ?></div><?php endif; ?><?php endif; ?><?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
		...
		<div id="aside">
                        <div class="btn-registry"><a href="/baoming" title="开发者报名">开发者报名</a></div>
			<div class="applist">
				<div class="section hot">
					<h2 class="tt-1"><span>热门排行</span></h2>
					<div class="cells">
					<?php if(is_array($hot)): $i = 0; $__LIST__ = array_slice($hot,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): ++$i;$mod = ($i % 2 )?><dl>
									<dd class="pic"><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><img src="<?php echo ($v["accessory"]["origin"]); ?>" alt="<?php echo ($v["name"]); ?>"><span class="cover"></span></a></dd>
									<dt><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><?php echo ($v["name"]); ?></a></dt>
				...
				<div class="section">
					<h2 class="tt-1"><span>最新推出</span></h2>
					<div class="cells">
					<?php if(is_array($new)): $i = 0; $__LIST__ = array_slice($new,0,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): ++$i;$mod = ($i % 2 )?><dl>
									<dd class="pic"><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><img src="<?php echo ($v["accessory"]["origin"]); ?>" alt="<?php echo ($v["name"]); ?>"><span class="cover"></span></a></dd>
									<dt><a href="<?php echo U('Circle/play/id/'.$v['id']);?>"><?php echo ($v["name"]); ?></a></dt>
								</dl><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
