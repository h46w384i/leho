        ...
        <div class="choosecities jvf_w100_con">
            <div class="hotcities">
                ...
                <p>
                    ...
                    <?php if(is_array($citydata["default"])): $i = 0; $__LIST__ = $citydata["default"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><a href="<?php echo U('Index/switchRegion/id/'.$vo['id']);?>">
                        <?php echo ($vo["name"]); ?>
            ...
            <div class="filter">
                <div id="changeCity">
                    ...
                    <span><input type="button" value="<?php echo L("enter_text");?>" class="btncit"></span>
                </div>
            </div>
                ...
                <?php if(is_array($citydata["all"])): $i = 0; $__LIST__ = $citydata["all"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><?php if(($vo["letter"])  !=  $citydata['all'][$key-1]['letter']): ?><li <?php if(($i)  ==  "1"): ?>class="hover"<?php endif; ?>>
                        <p class="clearfix">
                            ...
                            <span><?php endif; ?>
                                ...
                                <a href="<?php echo U('Index/switchRegion/id/'.$vo['id']);?>" class="isonline">
                                    	<?php echo ($vo["name"]); ?>
                                </a>
