...
$lang = array(
	...
	'tips_admininfo_comment' => '请牢记'.SOFT_NAME.'管理员密码，凭该密码登陆'.SOFT_NAME.'。',
	...
	'tips_soft_name' => '请填写'.SOFT_NAME.'相关信息',
	'tips_soft_name_comment' => SOFT_NAME.'是佳弗网络工作室核心产品程序，'.SOFT_NAME.'的安装和运行依赖此程序。',
	...
	'uc_ucurl_invalid' => 'UC的URL为空，或者格式错误，请检查',
	'uc_ucpw_invalid' => 'UC的创始人密码为空，或者格式错误，请检查',
	...
	'uc_version_incorrect' => '您的'.SOFT_NAME.'服务端版本过低，请升级'.SOFT_NAME.'服务端到最新版本，并且升级，下载地址：http://www.jvfnet.com/ 。',
...
<p>版权所有 (c) 2001-2010，佳弗网络工作室保留所有权利。</p>

<p>感谢您选择'.SOFT_NAME.'产品。希望我们的努力能为您提供一个高效快速和强大的站点解决方案。</p>

<p>佳弗网络工作室为'.SOFT_NAME.'产品的开发商，依法独立拥有'.SOFT_NAME.'产品著作权。佳弗网络工作室网址为 http://www.jvfnet.com，'.SOFT_NAME.'官方网站网址为 '.SOFT_SITE.'，'.SOFT_NAME.'官方讨论区网址为 '.SOFT_SITE_BBS.'。</p>

<p>'.SOFT_NAME.'著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用'.SOFT_NAME.'软件。</p>

<p>本授权协议适用且仅适用于'.SOFT_NAME.SOFT_VERSION.'版本，佳弗网络工作室拥有对本授权协议的最终解释权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
<li>您可以在协议规定的约束和限制范围内修改'.SOFT_NAME.'源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.jvfnet.com参考相关说明，也可以致电0371-55695967了解详情。</li>
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用'.SOFT_NAME.'的整体或任何部分，未经书面许可，页面页脚处的'.SOFT_NAME.'名称和佳弗网络工作室下属网站（http://www.jvfnet.com、'.SOFT_SITE.' 或 '.SOFT_SITE_BBS.'） 的链接都必须保留，而不能清除或修改。</li>
...
<li>佳弗网络工作室不对使用本软件构建的网站中的文章或信息承担责任。</li>
</ol>

<p>有关'.SOFT_NAME.'最终用户授权协议、商业授权与技术服务的详细内容，均由'.SOFT_NAME.'官方网站独家提供。佳弗网络工作室拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装'.SOFT_NAME.'，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p></div>',

	'uc_installed' => '您已经安装过'.SOFT_NAME.'，如果需要重新安装，请删除 Public/install.lock 文件',
